...
COMPETITION TABLE ФОРМАТ:
"competition_table": {{
  "our_name": "Название",
  "competitors": [{{"name": "Конкурент1"}}, {{"name": "Конкурент2"}}, {{"name": "Конкурент3"}}],
  "features": [
    {{"name": "Фича 1", "values": {{"Конкурент1": "no", "Конкурент2": "yes", "Конкурент3": "partial"}}}},
    ...
  ]
}}
Значения: "yes", "no", или короткий текст (макс 10 символов).
